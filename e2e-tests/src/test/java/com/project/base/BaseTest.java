...
public abstract class BaseTest {
  ...
  protected static final String BASE_UI_URL = System.getProperty("e2e.base.url.ui", 
    System.getenv().getOrDefault("E2E_BASE_URL_UI", "http://localhost:4200"));
  protected static final String BASE_API_URL = System.getProperty("e2e.base.url.api", 
